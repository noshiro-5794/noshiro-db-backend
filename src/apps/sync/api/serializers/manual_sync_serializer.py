...
class IncrementalSyncRunRequestSerializer(serializers.Serializer):
    ...
    task_name = serializers.ChoiceField(
        required=False,
        choices=tuple(IncrementalSyncService.TASKS),
    )
...
class CalendarSyncResultResponseSerializer(serializers.Serializer):
    ...
    detail_synced_count = serializers.IntegerField()
    detail_failed_count = serializers.IntegerField()
...
class SyncJobListRequestSerializer(serializers.Serializer):
    status = serializers.ChoiceField(
        required=False,
        choices=SyncJob.Status.choices,
    )
    job_type = serializers.ChoiceField(
        required=False,
        choices=SyncJob.JobType.choices,
    )
