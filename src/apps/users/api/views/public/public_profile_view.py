...
from apps.users.api.serializers.public.public_profile_serializer import (
    PublicCollectionListRequestSerializer,
    PublicCollectionResponseSerializer,
    PublicReviewListRequestSerializer,
...
class PublicUserSubjectListView(APIView):
    ...
    def get(self, request, user_id: int):
        ...
        query_serializer = PublicUserSubjectListRequestSerializer(
...
class PublicUserReviewListView(APIView):
    ...
    def get(self, request, user_id: int):
        ...
        query_serializer = PublicReviewListRequestSerializer(
            data=request.query_params,
        )
        query_serializer.is_valid(raise_exception=True)
...
class PublicUserCollectionListView(APIView):
    ...
    def get(self, request, user_id: int):
        ...
        query_serializer = PublicCollectionListRequestSerializer(
            data=request.query_params,
        )
        query_serializer.is_valid(raise_exception=True)
