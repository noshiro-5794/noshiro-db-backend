...
@extend_schema_view(
    ...
    post=extend_schema(
        request=CommunityTargetCommentCreateRequestSerializer,
...
@extend_schema_view(
    patch=extend_schema(
        request=CommunityCommentUpdateRequestSerializer,
        responses=api_responses({200: CommunityCommentResponseSerializer}),
    ),
...
@extend_schema_view(
    patch=extend_schema(
        request=CommunityCommentModerationRequestSerializer,
        responses=api_responses({200: CommunityCommentResponseSerializer}),
    )
)
